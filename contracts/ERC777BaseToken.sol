...
contract ERC777BaseToken is ERC777Token, ERC820Implementer {
    ...
    function operatorBurn(address _from, uint256 _amount, bytes _holderData, bytes _operatorData) public {
        require(isOperatorFor(msg.sender, _from), "No an operator");
        doBurn(msg.sender, _from, _amount, _holderData, _operatorData);
    }
